...
/**
 * This class is a rewrite of the original {@link JSch} class.
 */
public class JSch2 {
    /**
     * The version number.
     */
    public static final String VERSION  = "0.2.00";

    private final Map<String, String> config = new HashMap();

    void initializeConfiguration(Map<String, String> config){
    ...
    */
    ...
    public static void setLogger(Logger logger){
        ...
        com.jcraft.jsch.JSch.logger=logger;
    }
